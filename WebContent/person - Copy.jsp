...
$(document).ready(function() {
    // Click event for customerSearchButton
    $("#btnsearchPerson").click(function() {
        var customerIdValue = $("#pid").val(); // Get value from customerId field
        $("#searchValue").val(customerIdValue); // Set value in searchValue field
        $("#searchForm").show(); // Show the searchForm
    });
    		  ...
    		  <div class="container" style="width: 99%;float: left;"> 
    		   	<div class="form-group" align="left" style="width: 49%;float: left;">
					<div style="width: 85%;float: left;">
						...
						<input type="text" name="pid" id="pid" placeholder="Person ID" class="form-control"  size="20px" autocomplete="off" tabindex="1" readonly>
					...
					<div style="width: 15%;float: right;">	
						<br>					
						<button id="btnsearchPerson" class="btn btn-primary ms-2">Search</button>	
					</div>
